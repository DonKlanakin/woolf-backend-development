...
exports.createCustomer = async (req, res, next) => {
    try {
        ...
        if (servResponse.rowCount > 0) {
            ...
            errorHandler.throwCreationFailureError("Failed creating a customer.", res);
        }
    } catch (err) {
...
exports.getCustomerById = async (req, res, next) => {
    try {
        ...
        if (servResponse.rowCount > 0) {
            ...
            errorHandler.throwEntityIdNotFoundError("Failed creating a customer. CustomerId", id, res);
        }
    } catch (err) {
        errorHandler.mapError(err, req, res, next);
    }
...
exports.updateCustomerById = async (req, res, next) => {
    try {
        ...
        if (servResponse.rowCount > 0) {
            ...
            errorHandler.throwEntityIdNotFoundError("Failed updating a customer. CustomerId", id, res);
        }
    } catch (err) {
        errorHandler.mapError(err, req, res, next);
    }
...
exports.deleteCustomerById = async (req, res, next) => {
    try {
        ...
        if (servResponse.rowCount > 0) {
            ...
            errorHandler.throwEntityIdNotFoundError("Failed deleting a customer. CustomerId", id, res);
        }
    } catch (err) {
        errorHandler.mapError(err, req, res, next);
    }
